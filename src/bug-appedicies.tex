...
as well as his suggestions for naming conventions.
...
Thanks to Dr. Alan Kay for Smalltalk, the first language I loved.  And thanks
for describing Lisp as the ``Maxwell's equations of software'', which led
me to learn Lisp.
